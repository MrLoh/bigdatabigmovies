...
Bubble.prototype.create = function() {
	...
	//Random velocity
	var vel = bubbleOptions.vel*bubbleOptions.tick;
	this.xVel = (Math.random() * vel) - vel/2;
	this.yVel = (Math.random() * vel) - vel/2;

	//Set the size
	this.diam = Math.floor(Math.random() * bubbleOptions.minDiamRand) + bubbleOptions.minDiam;
